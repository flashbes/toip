...
public class MethodSerch {
    ...
    public static void binarySearch(int[] array, int first, int last, int item) {
        ...
        if (first <= last) {
            ...
            System.out.println("число найдено после " + comparisonCount +
                    " сравнений");
        } else {
            System.out.println("Элемент не найден в массиве, поиск закончил работу после "
